...
data_lowIsop = data_concat[data_concat.isop_mr < 1]
data_highIsop = data_concat[data_concat.isop_mr > 5]
#mean_dRHdt_filt
...
ax2.plot(data_lowIsop.index, data_lowIsop.pid4, color="blue", linewidth = 2) 
ax2.set_ylabel("PID / V")

ax4.plot(data_lowIsop.index, data_lowIsop.pid5, color="green", linewidth = 2)
ax4.set_ylabel("PID 5")
ax2.plot(data_lowIsop.index, data_lowIsop.pid6, color="red", linewidth = 2)
ax3.plot(data_lowIsop.index, data_lowIsop.RH, color="black", linewidth = 2)
ax3.set_ylabel("RH %")
ax3.set_xlabel("Time")
...
ax1a.plot(data_lowIsop.RH, data_lowIsop.pid4, 'o', color="purple", linewidth=1)
ax2a.plot(data_lowIsop.RH, data_lowIsop.pid5, 'o', color = "green", linewidth=1)
ax3a.plot(data_lowIsop.RH, data_lowIsop.pid6, 'o', color = "blue", linewidth=1)
