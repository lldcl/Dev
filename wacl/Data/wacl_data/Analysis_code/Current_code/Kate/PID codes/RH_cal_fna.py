...
# 	rhcalfig.show()
	...
	# net_flow = ((mean_resampled.mfchiR/5.)*2000.)+((mean_resampled.mfcloR/5.)*100.)
	net_flow = ((mean_resampled.mfchiR/5.)*2000.)
	mfcax.plot(mean_resampled.index,(mean_resampled.mfchiR/5.)*2000.,color='b',linewidth=3)
	mfcax.plot(mean_resampled.index,(mean_resampled.mfcloR/5.)*100.,color='r',linewidth=3)
