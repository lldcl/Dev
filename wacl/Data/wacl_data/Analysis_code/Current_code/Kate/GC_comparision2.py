...
dataframe = dataframe[["Time","Median_MOS_signal",'ethane', 'ethene', 'propane', 'propene','iso-butane','n-butane', 'iso-pentane', 'n-pentane', 'Total_VOC']]
...
ax2.set_xlabel(" GC NO2 / ppb", size =18)
ax2.set_ylabel("Median MOS signal (V)", size =18)
ax1.tick_params(labelsize =18 )
ax2.tick_params(labelsize =18 )
ax3.tick_params(labelsize =18 )
