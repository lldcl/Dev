...
cal_file = ['mos_data_050516_04.txt']
...
ax1.set_ylabel("MOS voltage (V)")
ax1.set_xlabel("Time since file began (seconds)")
Zoomfig.show()
...
ax1.plot(sliced.index, sliced.Sensor_ave)
plt.title('Graph of Individual Peak')
plt.xlabel('Time in Seconds since file began')
plt.ylabel('MOS Measurement in Volts')
plt.fill(sliced.index, sliced.Sensor_ave, 'r')
