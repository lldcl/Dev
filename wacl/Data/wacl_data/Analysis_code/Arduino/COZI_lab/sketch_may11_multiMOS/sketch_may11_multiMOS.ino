...
float gaintwo_multiplier = 1.00;    //0.0625; /* ADS1115  @ +/- 4.096V gain (16-bit results) */
...
//  Serial.println("takesample");
  ...
  tcaselect1(3);
  MOS1_stats.add(ads1115_4A.readADC_Differential_0_1());
  MOS2_stats.add(ads1115_4B.readADC_Differential_2_3());
  MOS3_stats.add(ads1115_49.readADC_Differential_0_1());
  MOS4_stats.add(ads1115_4B.readADC_Differential_0_1());
  MOS5_stats.add(ads1115_49.readADC_Differential_2_3());
  MOS6_stats.add(ads1115_48.readADC_Differential_0_1());
  MOS7_stats.add(ads1115_4A.readADC_Differential_2_3());
  MOS8_stats.add(ads1115_48.readADC_Differential_2_3());
  ...
  tcaselect2(6);
  MOS1b_stats.add(ads1115_4Ab.readADC_Differential_0_1());
  MOS2b_stats.add(ads1115_4Bb.readADC_Differential_2_3());
  MOS3b_stats.add(ads1115_49b.readADC_Differential_0_1());
  MOS4b_stats.add(ads1115_4Bb.readADC_Differential_0_1());
  MOS5b_stats.add(ads1115_49b.readADC_Differential_2_3());
  MOS6b_stats.add(ads1115_48b.readADC_Differential_0_1());
  MOS7b_stats.add(ads1115_4Ab.readADC_Differential_2_3());
  MOS8b_stats.add(ads1115_48b.readADC_Differential_2_3());
