// Import Arduino packages. Before using these download the library from the internet into the Arduino file 
// in Documents.
#include <Wire.h>
extern "C" { 
...
// A list of the different possible addresses.
...
//create statistics for each sensor. There are two recorded details per o3, co, no etc sensor and one for each MOS
