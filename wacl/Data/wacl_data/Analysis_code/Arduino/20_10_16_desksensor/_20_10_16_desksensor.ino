...
// Libraires for the pressure and humidity sensors
#include <Adafruit_BMP085.h>
//Name the pressure sensor "bmp"
Adafruit_BMP085 bmp;
#include <Adafruit_HTU21DF.h>
// Nme the humidity sensor "htu"
...
// Read the temperaute and pressure from the BMP180 sensor
  Temp1_stats.add(bmp.readTemperature());
  Press1_stats.add(bmp.readPressure());
  // Read the temperaute and humidity from the humdity sensor.
