...
#pid_corrections = {3:(2.073333333333333e-05),4:(9.3482608695652168e-06),5:(2.6714285714285718e-05)}
pid_corrections = {4:(2.6311610474699457e-05),5:(2.6867469263117031e-05),6:(2.65e-5)}
#pid_corrections = {3:(1.5e-05),4:(7.4e-06),5:(2.2-05)}
...
def plotter(pidxd,pidxdc,num):
    ...
    if humid_correct == 'Y':
        ...
        Corrected = mpatches.Patch(label=['Corrected Data'],color = 'r')

        Uncorrected = mpatches.Patch(label=['Uncorrected Data'],color = 'g')
