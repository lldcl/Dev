...
if (cal == 'Y'):
    ...
    pinch = 350   # Makes the data range smaller at each side by the pinch amount 
    translate = 450 # A positive translate is a translation to the right
    ...
    for i in range(0,len(mfc_setS)):
        x = mfc_setF[i]- mfc_setS[i]
        if x > 15000 and x<0:
            print 'These indexes in mfc_setS/mfc_setF are being funny ',i

    #mfc_setF[29] = mfc_setS[29]+10000
    
    #mfc_setF[30]= mfc_setS[30]-20000
    
    #mfc_setS[30] =mfc_setF[30]
