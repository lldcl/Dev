...
if (stat == 'Y'):
	...
	for p,c in zip(pids,colors):
		...
		sfig.plot(df_xrange.TheTime,pd.rolling_mean(df_xrange[p],20),color=c)
		ax2 = sfig.twinx()
		ax2.plot(data.TheTime,RH, linewidth=3,color='k')
