...
VOC2 = ['CH5O+ (methanol;H3O+) (ppb)',	'CH3CN.H+ (acetonitrile;H3O+) (ppb)',	'C3H7O+ (acetone;H3O+) (ppb)',	'C4H6O.H+ (3-buten-2-one;H3O+) (ppb)',	'C6H6.H+ (benzene;H3O+) (ppb)',	'C8H10.H+ (m-xylene;H3O+) (ppb)',	'C9H12.H+ (1,2,4-trimethylbenzene;H3O+) (ppb)',	'H3O+.C8H18 (octane;H3O+) (ppb)',	'C9H20.H3O+ (nonane;H3O+) (ppb)',	'H3O+.C10H22 (decane;H3O+) (ppb)',	'CH3O+ (formaldehyde;H3O+) (ppb)',
]
temp = matrix(data_merge["CH5O+ (methanol;H3O+) (ppb)"])
for i in VOC2[1:]:
        temp = temp + matrix(data_merge[i])
temp = temp.transpose()
voc_total = pd.DataFrame(temp)
print(np.corrcoef(voc_total[0], data_merge['MOS1c_Av'])[0][1])
print(np.corrcoef(voc_total[0], data_merge['rh'])[0][1])
print(np.corrcoef(data_merge['MOS1c_Av'],data_merge['rh'])[0][1])
print(np.corrcoef(data_merge['CH5O+ (methanol;H3O+) (ppb)'],data_merge['CO_ave1'])[0][1])
print(np.corrcoef(data_merge['rh'], data_merge['CO_ave1'])[0][1])
print(np.corrcoef(voc_total[0], data_merge['CO_ave1'])[0][1])
print(np.corrcoef(voc_total[0], data_merge['NO_ave1'])[0][1])
